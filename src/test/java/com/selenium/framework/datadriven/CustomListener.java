...
public class CustomListener extends TestListenerAdapter implements IInvokedMethodListener,ISuiteListener{
	...
	//	report(tr.getName(), tr.getThrowable().getMessage());
		...
		List<Throwable> verificationFailures = com.selenium.framework.datadriven.util.ErrorUtil.getVerificationFailures();
		String errMsg="";
	...
	public void onFinish(ISuite suite) {
		if(resultTable !=null){
			...
			if(!suite.getName().equals(com.selenium.framework.datadriven.util.Constants.SUITE_Root_NAME)){
				com.selenium.framework.datadriven.util.Xls_Reader xls = new com.selenium.framework.datadriven.util.Xls_Reader(resultFilePath);
